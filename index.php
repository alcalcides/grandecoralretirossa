...
<body class="container-fluid text-center">
	...
	<h1>Grande Coral da Congregação</h1>
	<h2>Assembléia de Deus em Retiro - Salvador(BA)</h2>
	
	<h3>Portal de comunicação!</h3>
	<p>Aqui o coralista encontra as informações mais relevantes!</p>
	...
	<section>
		...
		<ul style="list-style: none; margin-top: 30px;">			
			...
			<li><button type="button" class="btn btn-primary btn-md" onclick=irInscreverse()>Inscreva-se agora!</button></li>
		</ul>
